...
(function() {
   ...
   * After includes load, we (re)bind nav interactions if #navmenu exists.
   */
  ...
  /**
   * Bind interactions that require #navmenu content to exist
   */
  ...
  // Load includes as early as possible
